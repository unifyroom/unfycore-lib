...
For detailed technical information about a block please visit [Blocks](https://unfy-docs.github.io/en/glossary/block) on the Unifyroom Wiki.
...
For more information about the specific properties of a block header please visit the [Block headers](https://unfy-docs.github.io/en/developer-reference#block-headers) page on the Unifyroom Developer Reference Wiki.
