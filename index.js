...
bitcore.versionGuard = function (version) {
  if (version !== undefined) {
    var message =
      'More than one instance of unfycore-lib found. ' +
      'Please make sure that you are not mixing instances of classes of the different versions of unfycore.';
    console.warn(message);
  }
};
bitcore.versionGuard(global._unfycore);
global._unfycore = bitcore.version;
