...
var dataRawBlockBuffer = fs.readFileSync('test/data/blk00000.dat');

var dataRawBlockBinary = fs.readFileSync(
  'test/data/blk00000.dat',
  'binary'
);
var dataRawId =
  '001c87738f77f0c63e7c0f8da47be2146066927142c373333007b0b0be515c4b';
var data = require('../data/blk00000.js');
...
describe('BlockHeader', function () {
  ...
  describe('#fromRawBlock', function () {
    it('should instantiate from a raw block binary', function () {
      ...
      new BN(x.bits).toString('hex').should.equal('20001fff');
    });
  ...
  describe('#getDifficulty', function () {
    it('should get the correct difficulty for block 19976', function () {
      var x = BlockHeader.fromRawBlock(dataRawBlockBuffer);
      x.bits.should.equal(0x20001fff);
      x.getDifficulty().should.equal(0.47);
    });
