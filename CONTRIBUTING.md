...
- https://unifyroom.com/forum (Support Forum)
...
These are some global design goals in unfycore-lib that any change must adhere.
...
When possible, unfycore-lib objects should have standard methods on an instance prototype:
...
`JSON.stringify` and `JSON.parse` are expected to be handled outside of the scope of unfycore-lib methods. For example, calling `JSON.stringify` on an unfycore-lib object will behave as expected and call `transaction.toJSON()` and then stringify it:
...
#### T3 - Require 'unfycore' and Look up Classes from There

This helps to make tests more useful as examples, and more independent of where they are placed. This also helps prevent forgetting to include all submodules in the unfycore object.

DO:

```javascript
var unfycore = require('../');
var PublicKey = unfycore.PublicKey;
```
...
```sh
git remote add unify git@github.com:unifyroom/unfycore-lib.git
git pull --rebase unify master
```
...
Finally go to [github.com/unifyroom/unfycore-lib](https://github.com/unifyroom/unfycore-lib) in your web browser and issue a new pull request.

Main contributors will review your code and possibly ask for changes before your code is pulled in to the main repository. We'll check that all tests pass, review the coding style, and check for general code correctness. If everything is OK, we'll merge your pull request and your code will be part of unfycore-lib.

If you have any questions feel free to post them to
[github.com/unifyroom/unfycore-lib/issues](https://github.com/unifyroom/unfycore-lib/issues).
